...
unsigned int Textures::loadTexture(char const* path)
{
    ...
    if (data)
    {
        ...
        // set the properties and wrapping
    ...
    {
        // print error if the texture fails to load
...
// function to handle dallocation of resources following rendering
...
// loadCubemap is responsible for loading the six faces of the skybox from a vector of textures. 
